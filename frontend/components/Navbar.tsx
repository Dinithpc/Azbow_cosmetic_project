...
export default function Navbar() {
  const [cartItemCount, setCartItemCount] = useState(0); // Example initial cart count
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img alt="Diamond Cosmetics" src="/logo.png" className="h-16 w-18" />
              </div>
              <h2 className="text-2xl font-bold tracking-tight text-white p-5">Diamond Cosmetics</h2>
            </div>
              ...
              <div className="flex items-center">
                ...
                >
                  <Link href="/cart">
                    ...
                    {/* Cart item count in the top-right corner */}
                    {totalItems > 0 && (
